 ...
 * @type number
 * @min 1
 * @desc Adjusts the scale of the screen.
 * Default: 1
 * @default 1
 *
...
Yanfly.Param.ScreenScale  = Number(Yanfly.Parameters['Screen Scale'] || 1);
...
Yanfly.updateResolution = function() {
  var resizeWidth = (Yanfly.Param.ScreenWidth * Yanfly.Param.ScreenScale)- window.innerWidth;
  var resizeHeight = (Yanfly.Param.ScreenHeight * Yanfly.Param.ScreenScale)- window.innerHeight;
