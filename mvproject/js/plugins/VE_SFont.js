...
(function() {
	...
	if (Imported['VE - Basic Module']) {
		...
		VictorEngine.Parameters.SFont.Baseline = String(parameters["Baseline"]);
	...
	Bitmap.prototype.drawSFontText = function(text, x, y, maxWidth, lineHeight, align) {
		if (text !== undefined) {
			var tx = x;
			var ty = y  - VictorEngine.Parameters.SFont.Baseline + ((lineHeight - this.sfont.bitmap.height) / 2);
